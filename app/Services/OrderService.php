...
class OrderService
{
    ...
    protected function executeTrade(Order $buyOrder, Order $sellOrder): void
    {
        try {
            ...
            Log::error('Trade execution failed: ' . $th->getMessage());
            throw $th;
        }
    }
    ...
    protected function placeBuy(array $data, User $user): Order
    {
        try {
            ...
            Log::error('Place buy order failed: ' . $th->getMessage());
            throw $th;
        }
    }
    ...
    protected function placeSell(array $data, User $user): Order
    {
        try {
            ...
            Log::error('Place sell order failed: ' . $th->getMessage());
            throw $th;
        }
    }
    ...
    protected function attemptMatch(Order $order): void
    {
        try {
            ...
            Log::error('Attempt match failed: ' . $th->getMessage());
            throw $th;
        }
    }
}
